...
/**
 * Reference - https://github.com/Pakhee/Cross-platform-AES-encryption
 * 
 * Created by anuragrepaka on 05/05/17.
...
public class CryptLib {
    ...
    public CryptLib() 
    	...
    	//256 JCE default config changes
        ...
        System.out.println("maxKeyLen - maxKeyLen" + maxKeyLen);*/
    ...
    private String encryptDecrypt(String _inputText, String _encryptionKey,
        ...
        //System.out.println("encryptDecrypt - Encryption Key - " + _encryptionKey); 
        //System.out.println("encryptDecrypt - Non-Encr Key - " + Arrays.toString(_key)); 
        
        int len = _encryptionKey.getBytes("UTF-8").length; // length of the key	provided
        
        //System.out.println("encryptDecrypt - Non-Encr Key length - " + _key.length); 
        
        //System.out.println("encryptDecrypt - _encryptionKey length - " + len); 
        
        if (len > _key.length) {
        	     //System.out.println("encryptDecrypt - Take Non-Encr Key length - " + len);
        	     len = _key.length;
        }
        ...
        //System.out.println("Encryption Key - " + Arrays.toString(_key));
